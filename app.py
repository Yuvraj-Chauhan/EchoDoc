...
if choice == "🏠 Home":
    ...
    **Built using Open Source Stack (Llama 3.2, BGE Embeddings, and Qdrant running locally within a Docker Container.)**
    ...
    Enhance your document search experience with EchoDoc! 😊
    """)

# Chatbot Page
elif choice == "🤖 Chatbot":
    st.title("🤖 EchoDoc Chatbot (Llama 3.2 RAG 🦙)")
    st.markdown("---")
    ...
    with col1:
        ...
        if uploaded_file is not None:
            ...
            # st.markdown(f"**File Size:** {uploaded_file.size//1000000} MB")
...
# Contact Page
    ...
    - **Email:** [support@echodoc.com](mailto:strangedebugger01@gmail.com) ✉️
    - **GitHub:** [GitHub Repository](https://github.com/Yuvraj-Chauhan/EchoDoc) 🛠️
    """)

# Footer
st.markdown("---")
st.markdown("© 2024 EchoDoc 🤖.")
